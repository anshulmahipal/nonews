...
import { HOME_EDITORIALS_REVALIDATE_SECONDS } from "../lib/getHomeEditorials";
...
export function HomePageClient({
  ...
  const hasServerFirstPage = initialArticles.length > 0;
  ...
  const {
    ...
    initialData:
      hasServerFirstPage
        ...
        : undefined,
    staleTime: hasServerFirstPage
      ? HOME_EDITORIALS_REVALIDATE_SECONDS * 1000
      : 0,
